<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="products-flooring.aspx.cs" Inherits="mykb_modern.products_flooring" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">




<div class="ttm-page-title-row" style="background-image: url(../../Site/Pages/Banners/Products-flooring.webp);">
    <div class="ttm-page-title-row-inner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading" >
                        <h2 style="color: #cda274;" class="title">Flooring</h2>
                    </div>
                        ...
                        <div class="col-lg-4 widget-area sidebar-left">
                            <aside class="widget widget-nav-menu">
                                ...
                                <ul class="widget-menu">
                                    ...
                                    <li class="active"><a href="#">Flooring</a></li>
                                ...
                                <div class="ttm-service-classic-content">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="ttm_single_image-wrapper res-767-pt-30">
                                               <asp:Image ID="Image4" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Products/hw-18.webp" />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal23" runat="server" Text='<%# Eval("image1_title") %>'></asp:Literal></h2>
                                            <div class="overflow-hidden"> <asp:Literal ID="Literal24" runat="server" Text='<%# Eval("image1_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.bruce.com/en-us/products/solid-hardwood.html?size=24&filters=region%3Aundefined">Read More</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pb-30">
                                                <asp:Image ID="Image5" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Products/por.webp" />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal25" runat="server" Text='<%# Eval("image2_title") %>'></asp:Literal></h2>
                                            <div class="overflow-hidden"> <asp:Literal ID="Literal26" runat="server" Text='<%# Eval("image2_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="products-tiles.aspx">Read More</a>
                                    ...
                                    <div class="row">
                                                                                <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pt-30">
                                               <asp:Image ID="Image6" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Products/msi-1.webp" />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal11" runat="server" Text='<%# Eval("image3_title") %>'></asp:Literal></h2>
                                            <div class="overflow-hidden"> <asp:Literal ID="Literal12" runat="server" Text='<%# Eval("image3_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.msisurfaces.com/luxury-vinyl-flooring/">Read More</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pb-30">
                                                <asp:Image ID="Image7" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Products/hf.webp" />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal13" runat="server" Text='<%# Eval("image4_title") %>'></asp:Literal></h2>
                                            <div class="overflow-hidden"> <asp:Literal ID="Literal14" runat="server" Text='<%# Eval("image4_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.happy-floors.com/easy-luxury/">Read More</a>
                                    ...
                                    <div class="row">
                                                                                <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pt-30">
                                               <asp:Image ID="Image2" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Products/msi2.webp" />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal3" runat="server" Text='<%# Eval("image5_title") %>'></asp:Literal></h2>
                                            <div class="overflow-hidden"> <asp:Literal ID="Literal4" runat="server" Text='<%# Eval("image5_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.msisurfaces.com/waterproof-wood-flooring/woodhills/?utm_campaign=wood-flooring-search&utm_medium=cpc&utm_source=google_ads&utm_term=wood%20plank%20flooring&utm_content=ad1&gclid=CjwKCAjwzJmlBhBBEiwAEJyLu17n7S8Rdx7EvLLlj2qZ9nT3myBYGIX3Fy11M0qtiOdchv4zsKYaCRoCzR4QAvD_BwE">Read More</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pb-30">
                                                <asp:Image ID="Image3" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Products/deco.webp" />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal5" runat="server" Text='<%# Eval("image6_title") %>'></asp:Literal></h2>
                                            <div class="overflow-hidden"> <asp:Literal ID="Literal6" runat="server" Text='<%# Eval("image6_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.decovitausa.com/catalogue/Outdoor_Catalog_2023.pdf">Read More</a>
                                    ...
                                    <div class="row">
                                                                                <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pt-30">
                                               <asp:Image ID="Image8" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Products/ss.webp" />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal7" runat="server" Text='<%# Eval("image7_title") %>'></asp:Literal></h2>
                                            <div class="overflow-hidden"> <asp:Literal ID="Literal8" runat="server" Text='<%# Eval("image7_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.schluter.com/schluter-us/en_US/Floor-Warming/Schluter%C2%AE-DITRA-HEAT/p/DITRA_HEAT?facets=false">Read More</a>

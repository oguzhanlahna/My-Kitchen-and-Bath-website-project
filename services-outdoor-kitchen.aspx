<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="services-outdoor-kitchen.aspx.cs" Inherits="mykb_modern.services_outdoor_kitchen" %>
...
<div class="ttm-page-title-row" style="background-image: url(../../Site/Pages/Banners/Services-Outdoor-Kitchen.webp);">
    <div class="ttm-page-title-row-inner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading" >
                        <h2 style="color: #cda274;" class="title">Outdoor Kitchen</h2>
                    </div>
                        ...
                        <div class="col-lg-4 widget-area sidebar-left">
                            <aside class="widget widget-nav-menu">
                                ...
                                <ul class="widget-menu">
                                    ...
                                    <li class="active"><a href="#">Outdoor Kitchen</a></li>
                                </ul>
                            </aside>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="ttm_single_image-wrapper res-767-pb-30">
                                                            <asp:Image ID="Image2" runat="server" width="420" height="240" CssClass="img-fluid" alt="project-9" ImageUrl='<%# Eval("image1_file") %>'/> <%-- image1_file--%>

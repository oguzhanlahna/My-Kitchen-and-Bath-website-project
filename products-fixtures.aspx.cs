...
{
    public partial class products_fixtures : System.Web.UI.Page
    {
        ...
        public void products() // products-fixtures-cat_id=6
        {

            SqlConnection con = new SqlConnection(connString);
            con.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "select * from products where product_id=6";
            cmd.Connection = con;
            ...
            while (dr.Read())
            {
                ...
                Literal6.Text = dr["image4_title"].ToString();
                Literal7.Text = dr["image5_title"].ToString();
                Literal8.Text = dr["image6_title"].ToString();

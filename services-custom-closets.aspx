<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="services-custom-closets.aspx.cs" Inherits="mykb_modern.services_custom_closets" %>
...
<style> /*ReadMore and ReadLess algorithm*/ 
  .overflow-hidden {
    overflow: hidden;
    display: -webkit-box;
    -webkit-line-clamp: 2; /* İlk başta görüntülenecek satır sayısı */
    -webkit-box-orient: vertical;
    line-height: 1.2em; /* Satır yüksekliği */
    max-height: 2.4em; /* Satır sayısı * satır yüksekliği */
  }
</style>
...
<div class="ttm-page-title-row" style="background-image: url(../../Site/Pages/Banners/Services-Custom-Closet.webp);">
    <div class="ttm-page-title-row-inner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading" >
                        <h2 style="color: #cda274;" class="title">Custom Closet</h2>
                    </div>
                        ...
                        <div class="col-lg-4 widget-area sidebar-left">
                            <aside class="widget widget-nav-menu">
                                ...
                                <ul class="widget-menu">
                                    ...
                                    <li class="active"><a href="#">Custom Closet</a></li>
                            ...
                            <div class="row-title style2">
                                ...
                                <div class="section-title without-seperator text-center">
                                    <div class="title-header">
                                        <h2 class="title">Ready to see what your space could look like once it’s transformed by a custom closet
or a storage solution? Browse the spaces below to get inspired. We’re ready to dream
with you!
</h2>
                                    </div>

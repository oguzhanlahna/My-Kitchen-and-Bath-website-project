...
{
    public partial class admin_products_countertops : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                dt.Columns.Add("image8_title");
                dt.Columns.Add("image8_desc");
            ...
            else
            {
                ...
                String myquery = "select * from products where product_id=2";
                ...
                TextBox9.Text = ds.Tables[0].Rows[0]["image8_title"].ToString();
                CKEditorControl9.Text = ds.Tables[0].Rows[0]["image8_desc"].ToString();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand komut = new SqlCommand("UPDATE products SET pro_title = @pro_title, pro_desc = @pro_desc, " +
                    ...
                    "image8_title = @image8_title, image8_desc = @image8_desc " +
                    "WHERE product_id = 2", con);
                ...
                komut.Parameters.AddWithValue("@image8_title", TextBox9.Text);
                komut.Parameters.AddWithValue("@image8_desc", CKEditorControl9.Text);
                ...
                Response.Write("<script language='javascript'>window.alert('Update successful!'); window.location.href='admin-products-countertops.aspx';</script>");

            }
            catch (Exception hata)
            {
                //Label1.Text = hata.Message;
                Response.Write("<script language='javascript'>window.alert('Something went wrong. Try again or contact the administrator.'); window.location.href='admin-products-countertops.aspx';</script>");
            }
        }
    }
}
<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="admin-products-countertops.aspx.cs" Inherits="mykb_modern.admin.admin_products_countertops" %>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-info" Target="_blank" NavigateUrl="https://www.mykitchenandbath.com/products-countertops">View Page</asp:HyperLink> </li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                 ...
                 <div class="row">
                  <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>5.Photo</strong> <small> Section 2</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">
                                  <div class="row form-group">
                                    ...
                                    <div class="col col-sm-10">
                                        <asp:TextBox ID="TextBox6" runat="server" CssClass="input-sm form-control-sm form-control" placeholder="Enter a title"></asp:TextBox>
                                    </div>
                                </div>
                                  <div class="row form-group">
                                    <div class="col col-sm-2">
                                    ...
                                    <div class="col col-sm-10">
                                        <CKEditor:CKEditorControl ID="CKEditorControl6" runat="server"></CKEditor:CKEditorControl>
                                    </div>
                                </div>
                                    </div>
                                </div>
                      ...
                      <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>6.Photo</strong> <small> Section 2</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">                              
                                  ...
                                  <div class="row form-group">
                                    ...
                                    <div class="col col-sm-10">
                                        <CKEditor:CKEditorControl ID="CKEditorControl7" runat="server"></CKEditor:CKEditorControl>
                                    </div>
                                </div>
                                   </div>
                                </div>
                 ...
                 <div class="row">
                  <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>7.Photo</strong> <small> Section 2</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">
                                  <div class="row form-group">
                                    ...
                                    <div class="col col-sm-10">
                                        <asp:TextBox ID="TextBox8" runat="server" CssClass="input-sm form-control-sm form-control" placeholder="Enter a title"></asp:TextBox>
                                    </div>
                                </div>
                                  <div class="row form-group">
                                    <div class="col col-sm-2">
                                    ...
                                    <div class="col col-sm-10">
                                        <CKEditor:CKEditorControl ID="CKEditorControl8" runat="server"></CKEditor:CKEditorControl>
                                    </div>
                                </div>
                                    </div>
                                </div>
                      ...
                      <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>8.Photo</strong> <small> Section 2</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">                              
                                  ...
                                  <div class="row form-group">
                                    ...
                                    <div class="col col-sm-10">
                                        <CKEditor:CKEditorControl ID="CKEditorControl9" runat="server"></CKEditor:CKEditorControl>
                                    </div>
                                </div>
                                   </div>
                                </div>

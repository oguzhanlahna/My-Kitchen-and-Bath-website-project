...
{
    public partial class admin_products_decorative_hardware : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String myquery = "select * from products where product_id=4";
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand komut = new SqlCommand("UPDATE products SET pro_title = @pro_title, pro_desc = @pro_desc, image1_title = @image1_title, image2_title=@image2_title, image3_title=@image3_title WHERE product_id = 4", con);
                ...
                Response.Write("<script language='javascript'>window.alert('Update successful!'); window.location.href='admin-products-decorative-hardware.aspx';</script>");
            }
            catch (Exception hata)
            {

                //Label1.Text = hata.Message;
                Response.Write("<script language='javascript'>window.alert('Something went wrong. Try again or contact the administrator.'); window.location.href='admin-products-decorative-hardware.aspx';</script>");
            }
        }
    }
}
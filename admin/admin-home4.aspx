<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="admin-home4.aspx.cs" Inherits="mykb_modern.admin.admin_home4" %>
            ...
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col col-sm-5">
                                      <asp:TextBox ID="TextBox13" runat="server" CssClass="input-sm form-control-sm form-control" placeholder="Enter a description"></asp:TextBox>
                                    </div>
                                </div>
                  ...
                  <div class="col-xs-3 col-sm-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>1.ICON Part</strong> <small> Details</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">
                  ...
                  <div class="col-xs-3 col-sm-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>2.ICON Part</strong> <small> Details</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">
                  ...
                  <div class="col-xs-3 col-sm-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>3.ICON Part</strong> <small> Details</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">
                  ...
                  <div class="col-xs-3 col-sm-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>4.ICON Part</strong> <small> Details</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">
                 ...
                 <%--ICON 5--%>
                  <div class="col-xs-3 col-sm-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>5.ICON Part</strong> <small> Details</small>
                            </div>
                        <div class="card-body">
                                <div class="card-body card-block">
                            <div class="form-horizontal">
                                   ...
                                   <div class="row form-group">
                                    ...
                                    <div class="col col-sm-10">
                                        <asp:TextBox ID="TextBox11" runat="server" CssClass="input-sm form-control-sm form-control" placeholder="Enter a title"></asp:TextBox>
                                    </div>
                                </div>
                                   ...
                                   <div class="row form-group">
                                    ...
                                    <div class="col col-sm-10">
                                        <asp:TextBox ID="TextBox12" runat="server" TextMode="MultiLine" CssClass="input-sm form-control-sm form-control" placeholder="Enter a description"></asp:TextBox>
                                    </div>
                                </div>

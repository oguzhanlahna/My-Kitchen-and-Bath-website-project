<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="admin-home6.aspx.cs" Inherits="mykb_modern.admin.admin_home6" %>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col col-sm-5">
                                      <asp:TextBox ID="TextBox3" runat="server" CssClass="input-sm form-control-sm form-control" placeholder="Enter a description"></asp:TextBox>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-horizontal">
                                   ...
                                   <div class="row form-group">
                                    ...
                                    <div class="col col-sm-10">
                                        <asp:TextBox ID="TextBox7" runat="server" TextMode="MultiLine" CssClass="input-sm form-control-sm form-control" placeholder="Enter a description"></asp:TextBox>
                                    </div>
                                </div>

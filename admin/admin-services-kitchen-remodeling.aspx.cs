...
{
    public partial class admin_services_kitchen_remodeling : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String myquery = "select * from services where services_id=1";
                ...
                TextBox18.Text = ds.Tables[0].Rows[0]["ser_title2"].ToString();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand komut = new SqlCommand("UPDATE services SET ser_title = @ser_title, ser_desc = @ser_desc, image1_title=@image1_title, image1_sub_title = @image1_sub_title, image1_line1 = @image1_line1, image1_line2 = @image1_line2, image1_line3 = @image1_line3, image1_line4 = @image1_line4, image1_line5 = @image1_line5, image2_title = @image2_title, image2_sub_title = @image2_sub_title, image2_line1 = @image2_line1, image2_line2 = @image2_line2, image2_line3 = @image2_line3, image2_line4 = @image2_line4, image2_line5 = @image2_line5, image3_title = @image3_title, image3_desc = @image3_desc, image4_title = @image4_title, image4_desc = @image4_desc, ser_title2=@ser_title2, ser_desc2=@ser_desc2  WHERE services_id = 1", con);
                ...
                komut.Parameters.AddWithValue("@ser_title2", TextBox18.Text);

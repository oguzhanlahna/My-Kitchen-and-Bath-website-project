<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="services-basement-remodeling.aspx.cs" Inherits="mykb_modern.services_basement_remodeling" %>
...
<div class="ttm-page-title-row" style="background-image: url(../../Site/Pages/Banners/Services-Basement.webp);">
    <div class="ttm-page-title-row-inner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading" >
                        <h2 style="color: #cda274;" class="title">Basement Remodeling</h2>
                    </div>
                        ...
                        <div class="col-lg-4 widget-area sidebar-left">
                            <aside class="widget widget-nav-menu">
                                ...
                                <ul class="widget-menu">
                                    ...
                                    <li class="active"><a href="#">Basement Remodeling</a></li>
                        ...
                        <div class="col-lg-8 content-area">
                            <article class="ttm-service-single-content-area">
                                ...
                                <div class="ttm-service-classic-content">
                                    ...
                                    <div class="ttm-bgcolor-white pt-15 pb-25">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <div class="featured-icon-box icon-align-top-content style2">
                                                    ...
                                                    <div class="featured-content">
                                                        ...
                                                        <div class="featured-desc">
                                                            <p>Whether you have remodeling designs in mind for your basement or need inspiration, our professional designers are here to offer their help and advice.</p>
                                                        </div>
                                                        <div class="ttm-footer">
                                                            <a class="ttm-btn btn-inline ttm-btn-size-md ttm-icon-btn-right ttm-btn-color-darkgrey" href="About-Us.aspx">Read More</a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                ...
                                                <div class="featured-icon-box icon-align-top-content style2">
                                                    ...
                                                    <div class="featured-content">
                                                        <div class="featured-title">
                                                            <h3>Certified Remodeler</h3>
                                                        </div>
                                                        <div class="featured-desc">
                                                            <p>We are a Class-A licensed and insured contractor ready to offer your basement a brand new look and feel at an affordable price.</p>
                                                        </div>
                                                        <div class="ttm-footer">
                                                            <a class="ttm-btn btn-inline ttm-btn-size-md ttm-icon-btn-right ttm-btn-color-darkgrey" href="About-Us.aspx">Read More</a>
                                                        </div>
                                 ...
                                 <div class="ttm-horizontal_sep width-100 mt-30 mb-30 res-991-mt-15"></div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.mydreamcloset.com/">Read More</a>
                                   ...
                                   <div class="ttm-horizontal_sep width-100 mt-30 mb-30 res-991-mt-15"></div>
                                    <div class="row">
                                         ...
                                         <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pt-30">
                                               <asp:Image ID="Image2" runat="server" width="100%" height="100%" CssClass="img-fluid" alt="project-9" ImageUrl='<%# Eval("image3_file") %>' />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pb-30">
                                                <asp:Image ID="Image3" runat="server" width="100%" height="100%" CssClass="img-fluid" alt="project-9" ImageUrl='<%# Eval("image4_file") %>' />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-2">
                                ...
                                <!-- featured-imagebox end-->
                                   ...
                                   <div class="container">
                                <div class="ttm-service-classic-content">
                                    <p><asp:Literal ID="Literal27" runat="server" Text='<%# Eval("ser_desc2") %>'></asp:Literal></p> <%--description--%>
                                    </div>  </div>

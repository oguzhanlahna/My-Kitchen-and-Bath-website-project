...
{
    public partial class services_bathroom_remodeling : System.Web.UI.Page
    {
        ...
        public void services() // services-bathroom-cat_id=2
        {

            SqlConnection con = new SqlConnection(connString);
            con.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "select * from services where services_id=2";
            cmd.Connection = con;
            ...
            while (dr.Read())
            {
                ...
                Litera27.Text = dr["ser_title2"].ToString();
                Literal28.Text = dr["ser_desc2"].ToString();

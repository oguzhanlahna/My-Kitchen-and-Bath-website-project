<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="services-kitchen-remodeling.aspx.cs" Inherits="mykb_modern.services_kitchen_remodeling" %>
...
<style> /*ReadMore and ReadLess algorithm*/ 
  .overflow-hidden {
    overflow: hidden;
    display: -webkit-box;
    -webkit-line-clamp: 20; /* İlk başta görüntülenecek satır sayısı */
    -webkit-box-orient: vertical;
    line-height: 1.9em; /* Satır yüksekliği */
    max-height: 30.9em; /* Satır sayısı * satır yüksekliği */
  }
</style>
...
<div class="ttm-page-title-row" style="background-image: url(../../Site/Pages/Banners/Services-Kitchen.webp);">
    <div class="ttm-page-title-row-inner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading" >
                        <h2 style="color: #cda274;" class="title">Kitchen Remodeling</h2>
                    </div>
                        ...
                        <div class="col-lg-4 widget-area sidebar-left">
                            <aside class="widget widget-nav-menu">
                                ...
                                <ul class="widget-menu">
                                    <li class="active"><a href="#">Kitchen Remodeling</a></li>
                        ...
                        <div class="col-lg-8 content-area">
                                            ...
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="ttm_single_image-wrapper res-767-pt-30">
                                                    <asp:Image ID="Image2" runat="server" width="385" height="224" CssClass="img-fluid" alt="project-9" ImageUrl='<%# Eval("image1_file") %>'/> <%-- first image--%>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="ttm_single_image-wrapper res-767-pb-30">
                                                    <asp:Image ID="Image3" runat="server" width="385" height="224" CssClass="img-fluid" alt="project-9" ImageUrl='<%# Eval("image2_file") %>'/> <%-- second image--%>
                                            ...
                                            <div class="col-md-6">
                                                <div class="text-content">
                                                    <div class="icon-box"><i class="fa fa-check-square-o ttm-textcolor-skincolor"></i></div>
                                                    <div class="icon-content">
                                                        <h3><asp:Literal ID="Literal10" runat="server" Text='<%# Eval("image2_title") %>'></asp:Literal></h3> <%--second image title--%>
                          ...
                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:NewConnectionString %>' SelectCommand="SELECT * FROM [reviews]"></asp:SqlDataSource>
                                    ...
                                    <div class="row">
                                         <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pt-30">
                                               <asp:Image ID="Image4" runat="server" width="100%" height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Services/skr1.webp" />
                                            </div>
                                        </div>

                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal23" runat="server" Text='<%# Eval("image3_title") %>'></asp:Literal></h2>
                                            <div id="content" class="overflow-hidden"> <asp:Literal ID="Literal24" runat="server" Text='<%# Eval("image3_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" id="read-more">Read More</a>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" id="read-less" style="display: none;">Read Less</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pb-30">
                                                <asp:Image ID="Image5" runat="server" width="100%" height="100%" CssClass="img-fluid" alt="project-9" ImageUrl="~/Site/Pages/Services/skr2.webp" />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <h2><asp:Literal ID="Literal25" runat="server" Text='<%# Eval("image4_title") %>'></asp:Literal></h2>
                                            <div id="content1" class="overflow-hidden"> <asp:Literal ID="Literal26" runat="server" Text='<%# Eval("image4_desc") %>'></asp:Literal> </div>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" id="read-more1">Read More</a>
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" id="read-less1" style="display: none;">Read Less</a>

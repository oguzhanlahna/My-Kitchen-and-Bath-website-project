...
{
    public partial class products_flooring : System.Web.UI.Page
    {
        ...
        public void products() // products-flooring-cat_id=5
        {

            SqlConnection con = new SqlConnection(connString);
            con.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "select * from products where product_id=5";
            cmd.Connection = con;

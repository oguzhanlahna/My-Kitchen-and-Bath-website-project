...
{
    public partial class services_outdoor_kitchen : System.Web.UI.Page
    {
        ...
        public void services() // services-outdoor-kitchen-cat_id=9
        {

            SqlConnection con = new SqlConnection(connString);
            con.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "select * from services where services_id=7";
            cmd.Connection = con;

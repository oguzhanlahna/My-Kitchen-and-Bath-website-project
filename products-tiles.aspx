<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="products-tiles.aspx.cs" Inherits="mykb_modern.products_tiles" %>
...
<div class="ttm-page-title-row" style="background-image: url(../../Site/Pages/Banners/Products-Tile.webp);">
    <div class="ttm-page-title-row-inner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading" >
                        <h2 style="color: #cda274;" class="title">Tiles</h2>
                    </div>
                                ...
                                <div class="ttm-service-classic-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.happy-floors.com/">Read More</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://decovitausa.com/homepage/en">Read More</a>
                                    ...
                                    <div class="row">
                                                                                <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pt-30">
                                               <asp:Image ID="Image6" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl='<%# Eval("image3_file") %>' />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.tileshop.com/">Read More</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="ttm_single_image-wrapper res-767-pb-30">
                                                <asp:Image ID="Image7" runat="server" Width="100%" Height="100%" CssClass="img-fluid" alt="project-9" ImageUrl='<%# Eval("image4_file") %>' />
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey mt-20" href="https://www.msisurfaces.com/">Read More</a>

...
{
    public partial class services_basement_remodeling : System.Web.UI.Page
    {
        ...
        public void services() // services-basement-cat_id=3
        {

            SqlConnection con = new SqlConnection(connString);
            con.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "select * from services where services_id=3";
            cmd.Connection = con;
            ...
            while (dr.Read())
            {
                ...
                Image2.ImageUrl = dr["image3_file"].ToString();
                Image3.ImageUrl = dr["image4_file"].ToString();
                ...
                Literal27.Text = dr["ser_desc2"].ToString();

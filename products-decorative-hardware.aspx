<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="products-decorative-hardware.aspx.cs" Inherits="mykb_modern.products_decorative_hardware" %>
...
<div class="ttm-page-title-row" style="background-image: url(../../Site/Pages/Banners/Products-DecorativeHardware.webp);">
    <div class="ttm-page-title-row-inner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading" >
                        <h2 style="color: #cda274;" class="title">Decorative Hardware</h2>
                    </div>
                        ...
                        <div class="col-lg-4 widget-area sidebar-left">
                            <aside class="widget widget-nav-menu">
                                ...
                                <ul class="widget-menu">
                                    ...
                                    <li class="active"><a href="#">Decorative Hardware</a></li>
                        ...
                        <div class="ttm-box-col-wrapper col-md-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-post style1">
                                <div class="featured-thumbnail"> 
                                    <img width="650" height="510" class="img-fluid" src="Site/Pages/Products/products-decorative-1.webp" alt="image"> 
                                </div>
                                <div class="featured-content">
                                    ...
                                    <div class="ttm-postbox-desc-footer">
                                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey" href="https://www.hardwareresources.com/media/HardwareResources/Master_Resources/All_Catalogs/Product_Catalogs/Knobs_&_Pulls_Section.pdf">Read More</a>
                                    </div>
                                </div>
                           ...
                           <div class="ttm-box-col-wrapper col-md-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-post style1">
                                <div class="featured-thumbnail"> 
                                    <img width="650" height="510" class="img-fluid" src="Site/Pages/Products/products-decorative-2.webp" alt="image"> 
                                </div>
                                <div class="featured-content">
                         ...
                         <div class="ttm-box-col-wrapper col-md-6">
                            ...
                            <div class="featured-imagebox featured-imagebox-post style1">
                                <div class="featured-thumbnail"> 
                                    <img width="650" height="510" class="img-fluid" src="Site/Pages/Products/products-decorative3.webp" alt="image"> 
                                </div>
                                <div class="featured-content">
                                    ...
                                    <div class="ttm-postbox-desc-footer">
                                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-squar ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey" href="https://www.hardwareresources.com">Read More</a>
                                    </div>
                                </div>
                            </div><!--featured-imagebox-post end-->
                        </div>
